...
const ICON_DIR = path.resolve(__dirname, '..', 'icons', 'file-types');
...
function writeDocs() {
    ...
    const md = [
        ...
        '```',
        'icons/',
        '├── 01-name.svg ~ 60-name.svg       # 通用图标(60 个,4 态)',
        '└── file-types/',
        '    ├── file-{type}.svg             # 文件类型(238 个,4 态)',
        '    └── file-icon-map.json          # 扩展名 → type 映射(单一事实源)',
        '```',
        '',
        '原型页 `prototype/index.html` 提供两个 tab:扩展名 / 通用,默认进扩展名。',
        '',
        '## 1. 命名规则',
        '',
        '| 体系 | 命名 | 用途 | 数量 | 位置 |',
        '|---|---|---|---|---|',
        '| 通用图标 | `NN-name.svg` | 固定集合(60 个) | 固定 | `icons/` |',
        '| 文件类型 | `file-{type}.svg` | **无限集合**,按需扩展 | 持续 | `icons/file-types/` |',
        '',
        '**文件类型图标不带序号**,因为:',
        '',
        ...
        '',
        '```js',
        'import iconMap from \'/icons/file-types/file-icon-map.json\';',
        '',
        'function getIconByPath(filePath, kind) {',
        '    if (kind === \'folder\') return `icons/file-types/file-folder.svg`;',
        ...
        '            return `icons/file-types/file-${type}.svg`;',
        '        }',
        '    }',
        '    // 扩展名兜底',
        ...
        '### 3.2 HTTP 缓存建议',
        '',
        '- `icons/file-types/file-icon-map.json` → `Cache-Control: max-age=86400`(启动时拉一次)',
        '- `icons/file-types/file-{type}.svg` → `Cache-Control: public, max-age=2592000, immutable`(永不变)',
